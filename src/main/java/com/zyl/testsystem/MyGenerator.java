...
public class MyGenerator {
    ...
    public static void main(String[] args) {
        ...
        String mircoServiceName = scanner("微服务名（不包含hydra，以 '-' 间隔，例如supercode-management）");
        gc.setOutputDir(projectPath + "/" + projectName + "-" + mircoServiceName + "/src/main/java");
        gc.setAuthor("tingfeng.jiang");
        gc.setOpen(false);
        gc.setSwagger2(true);
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/t_test_system?useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        pc.setModuleName("testsystem");
        StringBuilder  sb = new StringBuilder();
        sb.append("com.").append("zyl.").append(projectName);
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/" + projectName + "-" + mircoServiceName + "-server/src/main/resources/mapper"
